...
{
    internal class SetSettingValueCommandValidator : CommandValidatorBase<SetSettingValueCommand>, ISetSettingValueCommandValidator
    {
        public SetSettingValueCommandValidator()
        {
