...
{
    class GetChatBotPartitionCollection : QueryBase, IGetChatBotPartitionCollection
    {
        private readonly IChatBotReadonlyContext _context;

        public GetChatBotPartitionCollection(ILogger<GetChatBotPartitionCollection> logger,
