...
{
    class GetChatBotSubpartitionDictionaryCollection : QueryBase, IGetChatBotSubpartitionDictionaryCollection
    {
        private readonly IChatBotReadonlyContext _context;

        public GetChatBotSubpartitionDictionaryCollection(ILogger<GetChatBotSubpartitionDictionaryCollection> logger,
