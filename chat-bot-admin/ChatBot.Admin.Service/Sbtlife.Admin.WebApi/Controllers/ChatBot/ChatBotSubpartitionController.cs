...
{
    [Route("chatbotsubparts")]
    [ResponseCache(Location = ResponseCacheLocation.None, NoStore = true)]
    public class ChatBotSubpartitionController : Controller
    {
        private readonly IPermissionsService _permissionsService;
        private readonly IGetChatBotSubpartitionCollection _getCollectionQuery;
        private readonly IGetChatBotSubpartitionItem _getItemQuery;

        public ChatBotSubpartitionController(IPermissionsService permissionsService,
            IGetChatBotSubpartitionCollection getCollectionQuery,
            IGetChatBotSubpartitionItem getItemQuery)
        {
