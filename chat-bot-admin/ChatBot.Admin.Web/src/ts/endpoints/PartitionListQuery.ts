...
export class PartitionListQuery {
    uri: string;
    baseUri: string;
    ...
    execute(query: string, skip: number, take: number, partitionId?: string): Promise<AxiosResponse> {
            ...
            this.authService.getToken().then(token =>
                {
                    ...
                    Axios
                        .post(
                            fullUri,
                            { search: query, skip: skip, take: take, partitionId: partitionId },
